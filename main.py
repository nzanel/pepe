...
class Interface(AnchorLayout):
    ...
    def guardar_y_enviar(self):
        ...
        hoja["d32"]=int(self.ids.sobre1.text)
        hoja["d33"]=int(self.ids.sobre2.text)
        hoja["d34"]=int(self.ids.sobre3.text)
        hoja["d35"]=int(self.ids.sobre4.text)
        hoja["d36"]=int(self.ids.sobre5.text)
        hoja["j32"]=int(self.ids.sobre6.text)
        hoja["j33"]=int(self.ids.sobre7.text)
        hoja["j34"]=int(self.ids.sobre8.text)
        hoja["j35"]=int(self.ids.sobre9.text)
        hoja["j36"]=int(self.ids.sobre10.text)
